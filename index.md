...
※今回のIVRC2020 SEED STAGEでは、***割り箸を使った爪切り機構の制作と、<br>木工での枠組み制作を行う必要はありません***。企画のコンセプト上、作り方を解説していますが、体験自体は[セットアップ](#セットアップ)以降のみで可能です。アプリのファイルやサーボモータの制御方法については後日公開予定です。
